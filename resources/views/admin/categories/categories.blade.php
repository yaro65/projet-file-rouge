            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <a style="max-width: 170px ;  float: right; display:inline-block;" href="{{ url('admin/add-edit-category')}}" class="btn btn-block btn-primary">Ajouter Categorie</a>
                  ...
                  <div class="table-responsive pt-3">
                    <table id="sections" class="table table-bordered">
                      ...
                      @php
                          if(isset($category['parentcategory']['category_nom']) && !empty($category['parentcategory']['category_nom'])) {
                              $parent_category = $category['parentcategory']['category_nom'];
                          } else {
