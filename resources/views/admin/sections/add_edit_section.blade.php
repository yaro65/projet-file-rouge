                ...
                <div class="card-body">
                  ...
                  <form class="forms-sample" @if(empty($section['id'])) action="{{url('admin/add-edit-section')}}"
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="nom" name="nom" placeholder="Entrer le nom de la section"
                      @if(!empty($section['nom'])) value="{{$section['nom']}}" @else value="{{old('nom')}}" @endif>
                     </div>
